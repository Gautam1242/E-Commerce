...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            <img className="w-20" src={
              !image1?assets.upload_area:URL.createObjectURL(image1)} alt="" />
      ...
      <button type='submit' className='w-28 py-3 mt-4 bg-white text-black hover:bg-black hover:text-white border-2'>ADD</button>
    </form>
  )
}
