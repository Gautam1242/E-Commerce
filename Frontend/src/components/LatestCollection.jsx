...
<<<<<<< HEAD
            <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>Discover the latest collection at ShopCArt – where trend meets comfort. From stylish fashion to must-have gadgets, explore handpicked items curated just for you.</p>
=======
